...
from exercises.views import (book_list, book_detail, classification_detail, classification_list, author_detail, author_list, 
                             publisher_detail, publisher_list, register, home, user_logout,
                              author_delete, author_form, author_update)
from exercises.views import (SearchPublisherView, SearchAuthorView, CreateBookView, UpdateBookView, 
                             DeleteBookView, CreatePublisherView, UpdatePublisherView, DeletePublisherView)
...
urlpatterns = [
    ...
    path('publishers/update/<int:pk>/', UpdatePublisherView.as_view(), name='publisher_update'),
    path('publishers/delete/<int:pk>/', DeletePublisherView.as_view(), name='publisher_delete')
]
